...
// 	for loopingStocks := 0; loopingStocks < 10; loopingStocks++ {
...
// 		lastID, err := stocksRepository.Insert(stocks)

// 		if err != nil {
// 			t.Errorf("error on testing stocks : %s", err.Error())
// 		}

// 		stocks.ProductID = int(lastID)
// 		listStocks = append(listStocks, &stocks)

// 		stocksOnDatabase, err := stocksRepository.Get(int(lastID))
...
// 		id := *&listStocks[stocks].ProductID
...
// 			Quantity:  110,
// 		}
// 		countEffect, err := stocksRepository.Update(stocks)
...
// 		stocksOnDatabase, err := stocksRepository.Get(int(id))
...
// 			if stock.Compare(*stocksOnDatabase[stocks]) {
...
// 		countEffect, err := stocksRepository.Delete(id)
